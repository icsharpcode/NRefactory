...
namespace ICSharpCode.NRefactory6.VisualBasic
{
	class ReflectionNamespaces
	{
		...
		internal const string VBWorkspacesAsmName = ", Microsoft.CodeAnalysis.VisualBasic.Workspaces, Version=1.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35";
		internal const string CAAsmName = ", Microsoft.CodeAnalysis, Version=1.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35";
		internal const string CACSharpAsmName = ", Microsoft.CodeAnalysis.VisualBasic, Version=1.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35";
	}
	
	class VisualBasicSyntaxContext
	{
		...
		static VisualBasicSyntaxContext()
		{
			typeInfo = Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Extensions.ContextQuery.VisualBasicSyntaxContext" + ReflectionNamespaces.VBWorkspacesAsmName, true);
		...
		VisualBasicSyntaxContext(object instance)
		{
			this.instance = instance;
		}

		internal static VisualBasicSyntaxContext CreateContext(Workspace workspace, SemanticModel semanticModel, int position, CancellationToken cancellationToken)
		{
			return new VisualBasicSyntaxContext(createContextMethod.Invoke(null, new object[] { workspace, semanticModel, position, cancellationToken }));
		}
	}

	class VisualBasicTypeInferenceService
	{
		readonly static Type typeInfo;
		...
		static VisualBasicTypeInferenceService()
		{
			typeInfo = Type.GetType("Microsoft.CodeAnalysis.VisualBasic.VisualBasicTypeInferenceService" + ReflectionNamespaces.VBWorkspacesAsmName, true);
		...
		public VisualBasicTypeInferenceService()
		{
	...
	class SpeculationAnalyzer
	{
		...
		static SpeculationAnalyzer()
		{
			Type[] abstractSpeculationAnalyzerGenericParams = new[]
			{
				...
				Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Syntax.ExpressionSyntax" + ReflectionNamespaces.CACSharpAsmName, true),
				Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Syntax.TypeSyntax" + ReflectionNamespaces.CACSharpAsmName, true),
				Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Syntax.AttributeSyntax" + ReflectionNamespaces.CACSharpAsmName, true),
				Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Syntax.ArgumentSyntax" + ReflectionNamespaces.CACSharpAsmName, true),
				Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Syntax.ForEachStatementSyntax" + ReflectionNamespaces.CACSharpAsmName, true),
				Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Syntax.ThrowStatementSyntax" + ReflectionNamespaces.CACSharpAsmName, true),
			...
			typeInfo = Type.GetType("Microsoft.CodeAnalysis.VisualBasic.Utilities.SpeculationAnalyzer" + ReflectionNamespaces.VBWorkspacesAsmName, true);
		}
