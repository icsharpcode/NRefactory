...
namespace NR6Pack.Analyzers
{
    [ExportCodeFixProvider("NR6Pack.AnalyzersCodeFixProvider", LanguageNames.CSharp), Shared]
    public class CodeFixProvider : Microsoft.CodeAnalysis.CodeFixes.CodeFixProvider
    {
        public sealed override ImmutableArray<string> GetFixableDiagnosticIds()
        {
            return ImmutableArray.Create(Analyzer.DiagnosticId);
        }
