...
This is a fork of [NRefactory](https://github.com/icsharpcode/NRefactory) that replaces the parser with the [PlayScript](https://github.com/PlayScriptRedux/playscript) mcs compiler to allow PlayScript & ActionScript parsing within the [Xamarin Studio / MonoDevelop PlayScript Language Addin](https://github.com/PlayScriptRedux/PlayScript.Addin).
